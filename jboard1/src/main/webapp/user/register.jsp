	...
	<section class="register">
		<form action="/jboard1/user/registerProc.jsp" method="post">
			<table border="0">
				...
				<tr>
					<td>아이디</td>
					<td><input type="text" name="uid" required placeholder="아이디 입력" />
						<button>
							<img src="../images/chk_id.gif" alt="아이디 중복체크" />
						</button> <span class="result_uid"></span></td>
				</tr>
				<tr>
					<td>비밀번호</td>
					<td><input type="password" name="pass1" required placeholder="비밀번호 입력" />
					</td>
				</tr>
				<tr>
					<td>비밀번호 확인</td>
					<td><input type="password" name="pass2"
						placeholder="비밀번호 입력 확인" /> <span
						class="result_pass"></span></td>
				</tr>
			</table>
			<table border="0">
				...
				<tr>
					<td>이름</td>
					<td><input type="text" name="name" required placeholder="이름 입력" /></td>
				</tr>
				<tr>
					<td>별명</td>
					<td>
						<p>공백없이 한글, 영문, 숫자만 입력가능</p> <input type="text" name="nick"
						required placeholder="별명 입력" /> <span class="result_nick"></span>
					</td>
				</tr>
				<tr>
					<td>Email</td>
